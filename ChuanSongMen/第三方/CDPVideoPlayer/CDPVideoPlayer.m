...
-(void)createFootBar{
    if (_footBar==nil) {
//        UIView *footView = [[UIView alloc] initWithFrame:CGRectMake(0,_initFrame.size.height,_initFrame.size.width,CDPFOOTHEIGHT)];
        
        
        _footBar=[[UIView alloc] initWithFrame:CGRectMake(0,_initFrame.size.height,_initFrame.size.width,CDPFOOTHEIGHT)];
