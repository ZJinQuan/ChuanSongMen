...
-(void)setupCollectionViewUI
{
    ...
    _picsCollection = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 64, KScrennWith, KScrennHeight - 104) collectionViewLayout:flowLayout];
...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.backgroundColor = RGB(0, 116, 180);
